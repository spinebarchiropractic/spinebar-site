            ...
            <div>
              ...
              {condition.causes && (
                <FadeIn className="mt-14" delay={0.1}>
                  <h2 className="mb-6 font-serif text-3xl text-green">
                    Common causes
                  </h2>
                ...
                <FadeIn className="mt-14" delay={0.15}>
                  <div className="rounded-2xl border border-cream-border bg-cream-dark p-8">
                    ...
                    <div className="mt-8 flex flex-wrap gap-4">
                      ...
                      <Button href="/new-patient" variant="outline">
                        New Patient Info
                      </Button>
                    </div>
                  </div>
              ...
              <FadeIn delay={0.2} direction="left">
                ...
                <div className="rounded-2xl border border-cream-border bg-cream-dark p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {condition.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-full border border-cream-border bg-cream px-3 py-1.5 text-xs text-green-muted"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className="rounded-2xl border border-green/10 bg-green p-6 text-cream">
                  ...
                  <Button
                    ...
                    external
                    variant="secondary"
                    className="w-full !bg-cream !text-green hover:!bg-cream-dark"
                  >
                    Book Your Visit
                  </Button>
                  <a
                    href={SITE.phoneHref}
                    className="mt-3 block text-center text-sm text-cream/60 transition-colors hover:text-cream"
                  >
                    Or call {SITE.phone}
                  </a>
                </div>
                ...
                <div className="rounded-2xl border border-cream-border bg-cream-dark p-6">
                  ...
                  <ul className="space-y-2">
                    {otherConditions.map((c) => (
                      <li key={c.slug}>
                        <Link
                          ...
                          className="flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm text-green-muted transition-colors hover:bg-cream hover:text-green"
                        >
                    ...
                    <li>
                      <Link
                        href="/conditions"
                        className="flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-medium text-gold transition-colors hover:bg-cream"
                      >
                        View all conditions →
                      </Link>
                    </li>
